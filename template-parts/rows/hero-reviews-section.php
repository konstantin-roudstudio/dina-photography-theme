...
<section class="hero-reviews">
  <?php if ($bg_img): ?>
    <div class="hero-reviews__bg<?php if ($bg_img && $bg_mob_img) echo ' hero-reviews__bg--desktop'; ?> animate-zoom">
      <?= $bg_img ?>
    </div>
  <?php endif; ?>

  <?php if ($bg_mob_img): ?>
    <div class="hero-reviews__bg<?php if ($bg_img && $bg_mob_img) echo ' hero-reviews__bg--mobile'; ?> animate-zoom">
      <?= $bg_mob_img ?>
    </div>
  <?php endif; ?>

  <div class="center hero-reviews__center animate-hero-content">
