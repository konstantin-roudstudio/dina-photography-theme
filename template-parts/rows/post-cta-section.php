...
if (have_rows('post_cta_section')):
  while (have_rows('post_cta_section')):
    the_row();
    ...
    <section class="post-cta">
      <div
          class="post-cta__bg parallax-slow"><?= wp_get_attachment_image($image, 'full', false, array('loading' => 'lazy')) ?></div>
        ...
        <div class="post-cta__content">
          ...
          <?php if ($check_link || $explore_link) : ?>
            <div class="post-cta__links-wrapper">
              <?php if ($check_link) : ?>
                <a href="<?= $check_link_url ?>" target="<?= $check_link_target ?>"
                   class="post-cta__btn btn btn--calendar"><?= $check_link_title ?></a>
              <?php endif; ?>

              <?php if ($explore_link) : ?>
                <a href="<?= $explore_link_url ?>" target="<?= $explore_link_target ?>"
                   class="post-cta__link"><?= $explore_link_title ?></a>
              <?php endif; ?>
            </div>
          <?php endif; ?>
        </div>
