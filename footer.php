...
$policy_link = get_field('footer_policy_link', 'option');

if ($policy_link) {
  $policy_url = $policy_link['url'];
  $policy_title = $policy_link['title'];
  $policy_target = $policy_link['target'] ? $policy_link['target'] : '_self';
}

$btn = get_field('contact_btn', 'option');
  ...
  <div class="footer__center center">
    <div class="footer__inner">
        ...
        <div class="footer__nav footer__nav--contact">
          ...
          <?php if ($fb_link && $insta_link) : ?>
            <div class="footer__socials socials">
              ...
              <?php if ($insta_link) : ?>
                <a class="socials__link" href="<?= $insta_link ?>">
                  <svg class="socials__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37 37">
      ...
      <div class="footer__bottom">
        <?php if ($btn) : ?>
        <a href="<?= $btn_url ?>" target="<?= $btn_target ?>" class="footer__btn btn btn--calendar">
        ...
        <?php endif; ?>
        <div class="footer__rights"><span><?= $copyright ?></span><?php if ($policy_link) : ?> <a href="<?= $policy_url ?>" target="<?= $policy_target ?>"><?= $policy_title ?></a>.<?php endif; ?></div>
      </div>
    </div>
